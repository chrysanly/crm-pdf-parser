...
const panels: Panel[] = [
    ...
    },
    {
        ...
        lines: [
            'php artisan telescope  # /telescope',
    ...
    },
    {
        ...
        lines: [
            'php artisan auth:setup login-register',
            'php artisan auth:setup login-social \\',
            '  --providers=google',
        ],
    },
];
            ...
            <div className="min-h-screen bg-[#FDFDFC] text-[#1b1b18] dark:bg-[#0a0a0a] dark:text-[#EDEDEC]">
                <div className="mx-auto flex min-h-screen w-full max-w-6xl flex-col p-6 lg:p-10">
                    ...
                    <main className="grid flex-1 items-center gap-10 py-10 lg:grid-cols-[1.4fr_1fr] lg:py-16">
                        <section>
                            ...
                            <h1 className="text-3xl font-semibold tracking-tight sm:text-4xl">
                                A batteries-included Laravel + React starting
                                point.
                            </h1>
                            <p className="mt-3 max-w-xl text-[15px] leading-relaxed text-[#706f6c] dark:text-[#A1A09A]">
                                Env-toggled feature modules, gated install
                                commands, and an AI engineering context — wired
                                and ready. Read{' '}
                                <code className="rounded bg-[#1b1b1810] px-1.5 py-0.5 text-[13px] dark:bg-[#ffffff14]">
                                    .claude/context/STARTUP.md
                                </code>{' '}
                                first.
                            </p>
                            ...
                            <p className="mt-5 text-xs text-[#706f6c] dark:text-[#A1A09A]">
                                ...
                                and{' '}
                                <code className="text-[13px]">auth:setup</code>{' '}
                                require maintainer authorization before running.
                            </p>
                        </section>
                        ...
                        <aside className="relative hidden aspect-[3/4] overflow-hidden rounded-2xl border border-[#19140015] shadow-sm lg:block dark:border-[#ffffff12]">
                            ...
                            <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/60 to-transparent p-4">
                                <p className="text-sm font-medium text-white">
                                    Ship the fourth site faster than the first.
                                </p>
                            </div>
                        </aside>
                    </main>
                    ...
                    <footer className="border-t border-[#19140012] pt-4 text-xs text-[#706f6c] dark:border-[#ffffff12] dark:text-[#A1A09A]">
                        Boilerplate · Laravel + React — configure the stack in{' '}
                        <code className="text-[13px]">config/features.php</code>
                        .
                    </footer>
                </div>
            </div>
